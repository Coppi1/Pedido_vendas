...
import 'package:projeto_pedido_vendas/repository/pagamento_dao.dart'; // Importando PagamentoDAO
import 'package:projeto_pedido_vendas/repository/parcela_pedido_dao.dart'; // Importando ParcelaPedidoDAO
...
class _PagamentoPageState extends State<PagamentoPage> {
  ...
  late List<ItensPedidoDTO> _itens = [];
                ...
                return Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      onChanged: (value) {
                        _gerarParcelas(value, _vencimentoController.text);
                      },
                    ),
                    const SizedBox(height: 8),
                    TextField(
